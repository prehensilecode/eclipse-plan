...
/* $Id: RPFilenameFilter.java 253 2008-06-24 18:25:24Z dwchin $ */
...
/** 
 * Filter for Eclipse plan file names 
 * @author David Chin
 * @version $Revision: 253 $
 */
public class RPFilenameFilter implements FilenameFilter {
    public boolean accept(File dir, String name) {
        return (name.startsWith("RP_") || name.startsWith("RP.")) && 
                name.endsWith(".dcm");
    }   
}
