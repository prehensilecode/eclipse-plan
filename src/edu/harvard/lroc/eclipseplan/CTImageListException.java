/* CTImageListException.java
 * Simple exception class for CTImageList
 */ 
 ...
 * @version $Revision$
 */
class CTImageListException extends Exception {
    public CTImageListException() {}
    
    public CTImageListException(String msg) {
        super(msg);
    }
}
