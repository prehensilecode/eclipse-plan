...
/*
 * $Id: CTFilenameFilter.java 253 2008-06-24 18:25:24Z dwchin $
 */ 
...
/**
 * Filename filter for Eclipse CT images.
 */
public class CTFilenameFilter implements FilenameFilter {

    public boolean accept(File dir, String name) {
        return (name.startsWith("CT_") || name.startsWith("CT.")) &&
                name.endsWith(".dcm");
    }
